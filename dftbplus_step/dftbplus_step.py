...
class DftbplusStep(object):
    ...
    my_description['description'] : tuple
        A description of the DFTB+ step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return dftbplus_step.Dftbplus(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return dftbplus_step.TkDftbplus(canvas=canvas, **kwargs)
